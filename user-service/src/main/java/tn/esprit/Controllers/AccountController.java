...
public class AccountController {
    ...
    @GetMapping("{id}")
    public ResponseEntity<AccountDto> SelectBy (@PathVariable int id) {return  iAccountService.SelectBy ( id) ;}

    @PostMapping
    public AccountDto Insert( @RequestBody AccountDto accountDto) {return  iAccountService.Insert(   accountDto);}

    @PutMapping
    public  ResponseEntity<AccountDto> update( @RequestBody AccountDto accountDto){return  iAccountService.update(  accountDto);}
